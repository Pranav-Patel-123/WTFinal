...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Retrieve the company name from the company_detail table
    $companyQuery = "SELECT company FROM company_detail WHERE id = $id";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "Error: Company details not found for user with ID $id";
    }
}
